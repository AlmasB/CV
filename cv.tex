...
\textsc{Oct 2015 - Present} & \textsc{Computer Science} Tutor for 1\textsuperscript{st} and 2\textsuperscript{nd} year students \\
& \emph{University of Brighton, UK}\\
\multicolumn{2}{c}{} \\

%------------------------------------------------

\textsc{June 2014 - Sept. 2014} & English-Russian Interpreter\\
...
\textsc{June} 2012 & Foundation Degree in \textsc{IT}, \normalsize\textbf{Bellerbys College International}, UK\\
...
\begin{tabular}{rl}
Basic Knowledge: & SQL, HTML5, CSS3, Haskell, Python, Node.js, {\fb \LaTeX}\setmainfont{Fontin-Regular.otf}\\
& Spring, FDD, TDD, Agile \\

Intermediate Knowledge: & C++, SDL2, OpenGL, Git, Win/Mac/Linux/Android\\

Advanced Knowledge: & Java, JavaFX, FXML, JS, JMonkey, Maven \\
& API Development, Software Development Principles and Practices \\
\end{tabular}
\bigskip
...
Data Visualization, Automated Graphical Layout Management \& Drawing\\
Chess, Cybersport\\
\bigskip
...
\begin{tabular}{rl}
\textsc{Google+:} & \href{https://www.google.com/+AlmasB0}{https://www.google.com/+AlmasB0} \\
